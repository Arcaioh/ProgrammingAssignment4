...
namespace ProgrammingAssignment4
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            Vector2 centreLocation = new Vector2(WindowWidth / 2 - teddySprite.Width / 2, WindowHeight / 2 - teddySprite.Height / 2);
            teddy = new TeddyBear(teddySprite, centreLocation);
        }
